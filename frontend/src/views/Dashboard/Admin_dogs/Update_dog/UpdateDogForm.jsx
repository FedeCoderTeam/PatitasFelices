				...
				<div className={style.boxForm}>
					<div className={style.containerInputsLeftForm}>
						<div className={style.containerInputs}>
							<label className={style.labels} htmlFor="name">Nombre
							</label>
							<input
						...
						<div className={style.containerInputs}>
							<label className={style.labels} htmlFor="age">Edad (meses)
							</label>
							<input
								className={style.inputs}
								value={input.age}
						...
						<div className={style.containerInputs}>
							<label className={style.labels} htmlFor="size">Tamaño
							</label>
						...
						<div className={style.containerInputsRightForm}>
							...
							<div className={style.containerInputs}>
								...
								<select
									...
									onChange={(event) => handlerChange(event)}
								>
									<option className={style.options} value="all"></option><option className={style.options} value={true}>Sí</option>
									<option className={style.options} value={false}>No</option>
								</select>
								<div className={style.errors}>
                                	{errors.adopted}
