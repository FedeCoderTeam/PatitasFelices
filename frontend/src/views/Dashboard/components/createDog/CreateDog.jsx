...
const CreateDogForm = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        colors: Yup.array()
            .of(Yup.string().oneOf(['Negro', 'Blanco', 'Gris', 'Marron', 'Dorado', 'Cobrizo', 'Crema']))
                        ...
                        errors }) => (<Form>
                            ...
                            <div className={style.boxCreateDog}>
                                <div className={style.containerInputsLeftCreateDog}>
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor='age'>Edad del Perro</label>
                                        <Field className={style.inputs} name='age' type='number' placeholder='Ej: 18 (meses).' />
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor='size'>Tamaño del Perro</label>
                                        <Field className={style.inputs} name='size' as='select' placeholder='Ej: Gigante'>
                                            ...
                                            <option className={style.options} value="Small">Pequeño</option>
                                            <option className={style.options} value="Mini">Mini</option>
                                        </Field>
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor='weight'>Peso del Perro</label>
                                        <Field className={style.inputs} name='weight' type='number' placeholder='Ej: 10 (kg)' />
                                ...
                                <div className={style.containerInputsRightCreateDog}>
                                    <div className={style.containerInputs}>
                                        ...
                                        <Field className={style.inputs} name='castrated' type='checkbox' />
                                    ...
                                    <div className={style.eachField}>
                                        ...
                                        <label className={style.labels} htmlFor='image'>Adjunte la imagen del perro</label>
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor="description">Cuenta sobre la historia del perro</label>
                                        <Field className={style.inputSelect} type='string' id="description" name="description">
                                        </Field>
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor="colors">Seleccione al menos un color</label>
                                        <Field className={style.inputSelect} as="select"multiple id="colors" name="colors">
                                            ...
                                            <option className={style.options} value="Marron">Marron</option>
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor="genders">Seleccione el género</label>
                                        <Field className={style.inputSelect} as="select" id="genders" name="genders">
                                            <option className={style.options} value="all"></option>
                                    ...
                                    <div className={style.containerInputs}>
                                        <label className={style.labels} htmlFor="tempers">Seleccione los temperamentos del perro</label>
                                        <Field className={style.inputSelect} as="select"multiple id="tempers" name="tempers">
                                            <option className={style.options} value="all"></option>
