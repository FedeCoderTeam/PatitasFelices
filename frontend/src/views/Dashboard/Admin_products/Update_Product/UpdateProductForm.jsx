    ...
    let handleSubmit = (event) => {
        ...
        if(
            ...
            let obj = {
                ...
                subCategoryId: input.subCategory === "Adulto" ? 1 : 
                (input.subCategory === "Cachorro" ? 2 :
                (input.subCategory === "Comederos" ? 3 : 
                (input.subCategory === "Collares" ? 4 : 
                (input.subCategory === "Juguetes" ? 5 : 
                (6)))))
            ...
            <form onSubmit={(event) => handleSubmit(event)}>
                <div>
                    <Link to='/dashboard/products'>
						<button className={style.goBackBtn}><i className={style.goBackBtn} class="fa-solid fa-arrow-left"></i></button>
					</Link>
